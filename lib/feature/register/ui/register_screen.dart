...
import 'package:foodie/feature/register/ui/widget/go_to_login_button.dart';
import 'package:foodie/feature/register/ui/widget/register_button.dart';
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: InkWell(
                                  onTap: () => context
                                      ...
                                      .setShowPassword(),
                                  child: Container(
                                    width: AppStyles.width(24),
                                    height: AppStyles.width(24),
                                    padding: state.isShowPassword
                                        ? EdgeInsets.all(AppStyles.width(8))
                                        : null,
                                    child: state.isShowPassword
                                        ? SvgPicture.asset(
                                            AppImage.icShowPass,
                                            width: AppStyles.width(18),
                                            height: AppStyles.width(18),
                                          )
                                        : Image.asset(
                                            AppImage.icHidePass,
                                            width: AppStyles.width(24),
