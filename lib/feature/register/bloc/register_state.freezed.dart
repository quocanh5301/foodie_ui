...
class _$RegisterStateImpl implements _RegisterState {
  ...
  @override
  String toString() {
    return 'RegisterState(email: $email, password: $password, name: $name, errorMessage: $errorMessage, isShowPassword: $isShowPassword, registerStatus: $registerStatus)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, email, password, name,
      errorMessage, isShowPassword, registerStatus);
